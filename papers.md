...
<tr><td colspan="2"><a href="#2-core-methods-and-geometry" style="color:#B22222">2. Core Methods and Geometry</a></td></tr>
<tr>
    <td>&ensp;<a href="#21-hyperbolic-shallow-models-and-embeddings">2.1 Hyperbolic Shallow Models and Embeddings</a></td>
    <td>&ensp;<a href="#22-hyperbolic-neural-networks">2.2 Hyperbolic Neural Networks</a></td>
</tr> 
<tr>
    <td>&ensp;<a href="#23-hyperbolic-graph-neural-networks">2.3 Hyperbolic Graph Neural Networks</a></td>
    <td>&ensp;<a href="#24-attention-transformers-and-sequence-models">2.4 Attention, Transformers, and Sequence Models</a></td>
</tr>
<tr>
    <td>&ensp;<a href="#25-theory-analysis-and-numerical-stability">2.5 Theory, Analysis, and Numerical Stability</a></td>
    <td>&ensp;<a href="#26-hierarchy-and-tree-modeling">2.6 Hierarchy and Tree Modeling</a></td>
</tr>
<tr>
    <td>&ensp;<a href="#27-mixed-curvature-and-alternative-geometries">2.7 Mixed-Curvature and Alternative Geometries</a></td>
    <td>&ensp;<a href="#28-hyperbolic-generative-models">2.8 Hyperbolic Generative Models</a></td>
</tr>
<tr>
    <td>&ensp;<a href="#29-hyperbolic-classifiers-and-decision-models">2.9 Hyperbolic Classifiers and Decision Models</a></td>
    <td>&ensp;<a href="#210-hyperbolic-operations-and-representation-utilities">2.10 Hyperbolic Operations and Representation Utilities</a></td>
</tr>
<tr>
    <td>&ensp;<a href="#211-llms-and-foundation-models">2.11 LLMs and Foundation Models</a></td>
    <td></td>
</tr>
<tr><td colspan="2"><a href="#3-domain-applications" style="color:#B22222">3. Domain Applications</a></td></tr>
<tr>
    <td>&ensp;<a href="#31-language-and-text-applications">3.1 Language and Text Applications</a></td>
    <td>&ensp;<a href="#32-computer-vision-graphics-and-robotics">3.2 Computer Vision, Graphics, and Robotics</a></td>
</tr>
<tr>
    <td>&ensp;<a href="#33-graphs-and-networked-data">3.3 Graphs and Networked Data</a></td>
...
<tr>
    ...
    <td>&ensp;<a href="#36-biology-and-molecular-learning">3.6 Biology and Molecular Learning</a></td>
</tr>
<tr>
    <td>&ensp;<a href="#37-code-representation">3.7 Code Representation</a></td>
    <td>&ensp;<a href="#38-education-and-learning-analytics">3.8 Education and Learning Analytics</a></td>
</tr>
<tr><td colspan="2"><a href="#4-task-oriented-settings" style="color:#B22222">4. Task-Oriented Settings</a></td></tr>
<tr>
    <td>&ensp;<a href="#41-multi-label-and-hierarchical-classification">4.1 Multi-label and Hierarchical Classification</a></td>
    <td>&ensp;<a href="#42-metric-learning-retrieval-and-clustering">4.2 Metric Learning, Retrieval, and Clustering</a></td>
</tr>
<tr>
    <td>&ensp;<a href="#43-data-driven-geometry-learning-and-adaptation">4.3 Data-Driven Geometry Learning and Adaptation</a></td>
    <td>&ensp;<a href="#44-few-shot-and-low-data-learning">4.4 Few-Shot and Low-Data Learning</a></td>
</tr>
<tr>
    <td>&ensp;<a href="#45-open-vocabulary-zero-shot-and-category-discovery">4.5 Open-Vocabulary, Zero-Shot, and Category Discovery</a></td>
    <td>&ensp;<a href="#46-safety-robustness-and-privacy">4.6 Safety, Robustness, and Privacy</a></td>
</tr>
<tr>
    <td>&ensp;<a href="#47-environmental-monitoring">4.7 Environmental Monitoring</a></td>
    <td>&ensp;<a href="#48-multi-criteria-learning">4.8 Multi-Criteria Learning</a></td>
</tr>
</table>
...
## [2. Core Methods and Geometry](#content)

### [2.1 Hyperbolic Shallow Models and Embeddings](#content)
...
### [2.2 Hyperbolic Neural Networks](#content)
...
### [2.4 Attention, Transformers, and Sequence Models](#content)
...
### [2.5 Theory, Analysis, and Numerical Stability](#content)
...
### [2.6 Hierarchy and Tree Modeling](#content)
...
1. [From Trees to Continuous Embeddings and Back: Hyperbolic Hierarchical Clustering](https://arxiv.org/abs/2010.00402) \
...
1. [Mixed-curvature Variational Autoencoders](https://openreview.net/pdf?id=S1g6xeSKDS), ICLR 2020 \
...
1. [Linear Classifiers in Product Space Forms](https://arxiv.org/abs/2102.10204), arXiv 2022 \
...
### [2.10 Hyperbolic Operations and Representation Utilities](#content)
...
1. Backward-compatible Representation Learning \
[Learning Along the Arrow of Time: Hyperbolic Geometry for Backward-Compatible Representation Learning](https://arxiv.org/abs/2506.05826), ICML 2025 \
...
### [3.1 Language and Text Applications](#content)
...
1. [Cross-lingual Word Embeddings in Hyperbolic Space](https://arxiv.org/abs/2205.01907), arXiv 2022 \
...
1. [Rethinking the compositionality of point clouds through regularization in the hyperbolic space](https://arxiv.org/abs/2209.10318), NeurIPS 2022 \
Antonio Montanaro, Diego Valsesia, Enrico Magli

1. [HypLiLoc: Towards Effective LiDAR Pose Regression with Hyperbolic Fusion](https://arxiv.org/abs/2304.00932), CVPR 2023 \
...
1. [Hyperbolic Node Embedding for Signed Networks](https://arxiv.org/abs/1910.13090), Neurocomputing 2021 \
...
1. [Hyperbolic Personalized Tag Recommendation](https://link.springer.com/chapter/10.1007/978-3-031-00126-0_14), DASFAA 2022 \
...
### [3.6 Biology and Molecular Learning](#content)
...
1. [Semi-supervised hierarchical drug embedding in hyperbolic space](https://pubs.acs.org/doi/10.1021/acs.jcim.0c00681), Journal of Chemical Information and Modeling 2020 \
...
1. [GeoPhy: Differentiable Phylogenetic Inference via Geometric Gradients of Tree Topologies](https://arxiv.org/abs/2307.03675), NeurIPS 2023 \
...
1. [Poincare Maps for Analyzing Complex Hierarchies in Single-Cell Data](https://pubmed.ncbi.nlm.nih.gov/32528075/), Nature Communications 2020 \
...
1. [Contrastive Poincare Maps for single-cell data analysis](https://openreview.net/pdf?id=zsUKE98bNu), ICLR workshop 2024 \
...
### [3.8 Education and Learning Analytics](#content)
...
## [4. Task-Oriented Settings](#content)
...
### [4.1 Multi-label and Hierarchical Classification](#content)
...
1. [Contrastive Multi-view Hyperbolic Hierarchical Clustering](https://arxiv.org/abs/2205.02618), IJCAI 2022 \
...
1. [CO-SNE: Dimensionality Reduction and Visualization for Hyperbolic Data](https://arxiv.org/abs/2111.15037), CVPR 2022 \
Yunhui Guo, Haoran Guo, Stella Yu

1. [HyperAid: Denoising in hyperbolic spaces for tree-fitting and hierarchical clustering](https://arxiv.org/abs/2205.09721), KDD 2022 \
...
### [4.5 Open-Vocabulary, Zero-Shot, and Category Discovery](#content)
...
### [4.8 Multi-Criteria Learning](#content)
